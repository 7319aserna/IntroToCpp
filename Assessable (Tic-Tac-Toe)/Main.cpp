...
int start (int * arr, int indexMin, int indexMax)
{
	int source[] = { 1, 2, 3, 4, 5 };

	for (int p = arr[indexMin]; p <= indexMax; p++)
	{
		int index = 0;
...
{
	/*
	GridThreeByThreeTest threeBythree = {};
	printGridThreeByThreeTest(threeBythree);
	*/
	...
	*/
	...
	// Get Integer Subarray)
	std::cout << "(Get Integer Subarray)" << std::endl;
